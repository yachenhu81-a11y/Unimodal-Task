...
│   ├── QuickDraw_generation/        # B. 生成数据集 (.npz)
│
...
│   ├── reconstruction/              # 重构生成结果
│   ├── test_sketch/                 # 存放训练中间图片和模型checkpoint
│   ├── sketch_rnn.py                # 训练生成模型
│   ├── inspect_samples.py           # 挑选草图id
│   ├── reconstruct_samples.py       # 重构草图
│   ├── interpolation.py             # 隐向量插值
│   └── insmetric.py                 # 评估脚本
│
├── README.md                        # 项目说明书
